...
namespace Ecommerces_asp.net.Areas.Admin.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        {
            ViewBag.detail = _context.OrderDetails;
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CustommerName,ProductName,UnitPrice,Quantity,Discount")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustommerName,ProductName,UnitPrice,Quantity,Discount")] OrderDetail orderDetail)
        {
